...
function calcular() {
  ...
  //Se a quantidade de carne for menor que 1k sera mostrado em gramas não em kg e acima de 999 gramas vai ser mostrado em kg
  ...
  resultado.innerHTML += `
    <div class="result-block">
      ...
      <p>${Math.ceil(qdtTotalBebidas/2000)} garrafas de refrigerante ou soda</p>
    </div>
    </br>
